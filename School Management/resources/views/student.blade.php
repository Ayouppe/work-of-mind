...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-content">
        ...
        <div style="width: 80%; margin: 30px auto; margin-top: 50px; background: #2d3748; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            <h1 style="text-align: center; color: #4CAF50; margin-bottom: 20px;">Students Management</h1>

            <!-- Button to add a new student -->
            <div style="text-align: center; margin-bottom: 20px;">
                <button onclick="window.location='{{ route('students.create') }}'"
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: center;">
                ...
                <tr style="background-color: #f5f5f5; color: #333; border-bottom: 2px solid #ddd;">
                    ...
                    <th style="padding: 10px;">Enrolled Courses</th>
                        ...
                        <td style="padding: 10px; text-align: left;">
                            <ul style="list-style: none; padding: 0; margin: 0; text-align: center">
                                ...
                                @if($student->enrollments->isEmpty())
                                    <li style="color: white;">No courses enrolled.</li>
                                @endif
                            </ul>
                        </td>
                        <td style="padding: 10px;">

                            <button onclick="window.location='{{url('edit_student',$student->id)}}'"
                                    style="padding: 5px 10px; background-color: #ffc107; color: white; border: none; border-radius: 5px; font-size: 14px; cursor: pointer;">
                                Edit
                            </button>
                        </td>
                        <td>
                                <a href="{{ url('delete_student',$student->id) }}"  style="padding: 5px 10px; background-color: #dc3545; color: white; border: none; border-radius: 5px; font-size: 14px; cursor: pointer;"
